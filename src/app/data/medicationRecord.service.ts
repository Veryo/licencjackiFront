...
export class MedicationRecordService {
  ...
  postMedicationRecord(medicationRecord: MedicationRecord): Observable<MedicationRecord> {
    return this.http.post<MedicationRecord>(`${this.baseUrl}`, medicationRecord);
  }
